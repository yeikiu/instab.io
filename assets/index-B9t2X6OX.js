 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Pt=new Mc("@firebase/analytics");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ym(t){t=Mt(t,wt);const e=Mt(t.firestore,Ts);return uO(yl(e),t._key).then(n=>NO(e,t,n))}class mf extends CO{constructor(e){super(),this.firestore=e}convertBytes(e){return new Wr(e)}convertReference(e){const n=this.convertDocumentKey(e,this.firestore._databaseId);return new wt(this.firestore,null,n)}}function SM(t){t=Mt(t,en);const e=Mt(t.firestore,Ts),n=yl(e),s=new mf(e);return wO(t._query),Yw(n,t._query).then(r=>new hb(e,s,t,r))}function CM(t){t=Mt(t,en);const e=Mt(t.firestore,Ts),n=yl(e),s=new mf(e);return Yw(n,t._query,{source:"server"}).then(r=>new hb(e,s,t,r))}function kO(t,e,n){t=Mt(t,wt);const s=Mt(t.firestore,Ts),r=lb(t.converter,e,n);return wl(s,[tb(Bo(s),"setDoc",t._key,r,t.converter!==null,n).toMutation(t._key,Bt.none())])}function RO(t,e,n,...s){t=Mt(t,wt);const r=Mt(t.firestore,Ts),i=Bo(r);let o;return o=typeof(e=Ue(e))=="string"||e instanceof vl?yO(i,"updateDoc",t._key,e,n,s):gO(i,"updateDoc",t._key,e),wl(r,[o.toMutation(t._key,Bt.exists(!0))])}function AM(t){return wl(Mt(t.firestore,Ts),[new Vd(t._key,Bt.none())])}function xO(t,e){const n=Mt(t.firestore,Ts),s=oc(t),r=lb(t.converter,e);return wl(n,[tb(Bo(t.firestore),"addDoc",s._key,r,t.converter!==null,{}).toMutation(s._key,Bt.exists(!1))]).then(()=>s)}function wl(t,e){return function(n,s){const r=new kn;return n.asyncQueue.enqueueAndForget(async()=>zN(await lO(n),s,r)),r.promise}(yl(t),e)}function NO(t,e,n){const s=n.docs.get(e._key),r=new mf(t);return new ub(t,r,e._key,s,new yi(n.hasPendingWrites,n.fromCache),e.converter)}(function(t,e=!0){(function(n){ri=n})(ti),Yt(new Vt("firestore",(n,{instanceIdentifier:s,options:r})=>{const i=n.getProvider("app").getImmediate(),o=new Ts(new Px(n.getProvider("auth-internal")),new Fx(n.getProvider("app-check-internal")),function(a,c){if(!Object.prototype.hasOwnProperty.apply(a.options,["projectId"]))throw new L(_.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Xi(a.options.projectId,c)}(i,s),i);return r=Object.assign({useFetchStreams:e},r),o._setSettings(r),o},"PUBLIC").setMultipleInstances(!0)),St(_m,"3.8.0",t),St(_m,"3.8.0","esm2017")})();/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
